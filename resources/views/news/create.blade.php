        ...
        <div class="col-sm-8 col-sm-offset-2">
            ...
            <form action="{{ url('news') }}" method="post">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">Tambah Artikel/Berita</div>
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" rows="10" name="news"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <input type="submit" class="btn btn-primary" value="Simpan">
                                <a class="btn btn-default" href="{{ url('news') }}" role="button">Batal</a>
                            </div>
                        </div>
                    </div>
                </div>
